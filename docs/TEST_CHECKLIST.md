# v7.0.4 Test Checklist

- [ ] Root URL redirects to Business OS.
- [ ] Business OS displays v7.0.4 and loads existing data.
...
- [ ] Existing leads, clients, events and booking requests remain accessible.
- [ ] Browser console contains no module-path or 404 errors.
